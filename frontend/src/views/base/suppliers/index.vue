<template>
  <div class="supplier-container">
    ...
    <el-table :data="supplierList" v-loading="loading" style="width: 100%; margin-top: 20px;" border>
...
import { getSupplierPage, createSupplier, updateSupplier, deleteSupplier } from '@/api/base/supplier'
